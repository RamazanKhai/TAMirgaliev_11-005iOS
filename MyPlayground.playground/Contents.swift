...
//    func isAlive() -> Bool { // проверка того жив ли персонаж
//        if (hp < 1 ){return false}
//        else{return true}
//    }
    
        
//    func takeAHit(anotherPlayer : SimplePlayer) -> Bool { // проверка поали ли в игрока
//        if(Int.random(in: 1...2) == 2){  // шанц того что попадет = 0.5
//            return true
//        }else{return false}
//    }
}
